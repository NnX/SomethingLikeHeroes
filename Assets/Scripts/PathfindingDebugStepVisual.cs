        ...
        for (int x = 0; x < grid.GetWidth(); x++) {
            for (int y = 0; y < grid.GetHeight(); y++) {
                ...
                gridSnapshotAction.AddAction(() => {
                    ...
                    Color backgroundColor = UtilsGrid.GetColorFromString("636363");

                    if (isInClosedList) {
                        backgroundColor = new Color(1, 0, 0);
                    }
                    if (isInOpenList) {
                        backgroundColor = UtilsGrid.GetColorFromString("009AFF");
                    }
                    if (isCurrent) {
            ...
            for (int y = 0; y < grid.GetHeight(); y++) {
                ...
                gridSnapshotAction.AddAction(() => { 
                    ...
                    if (isInPath) {
                        ...
                        backgroundColor = UtilsGrid.GetColorFromString("636363");
                    }
